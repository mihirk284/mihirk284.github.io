...
{{ youtube(id="himJeiOUY-Q") }}

{{ youtube(id="0YC74ONUpf8") }}

{{ youtube(id="iJqPAy0_tGM") }}

{{ youtube(id="e4maqzFRJmY") }}
...
I worked on:
- Motion planning and controls for cooperation between ground and aerial robots.
- Artifact detection pipeline using YOLO-v3.
- Hardware and software framework integration for aerial and wheeled robots.
- Drone safety piloting.
