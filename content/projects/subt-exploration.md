+++
title = "Autonomous Teamed Exploration (DARPA SubT)"
description = "Teamed exploration of subterranean environments using legged and aerial robots."
weight = 80
draft = false

[taxonomies]
tags = ["Competition", "Autonomy", "Publications"]

[extra]
local_image = "img/projects/subt-exploration.jpg"
+++

{{ youtube(id="P3uT4gHEFHw") }}

**Authors**: M. Kulkarni, M. Dharmadhikari, M. Tranzatto, S. Zimmermann, V. Reijgwart, P. De Petris, H. Nguyen, N. Khedekar, C. Papachristos, L. Ott, R. Siegwart, M. Hutter and K. Alexis.

**Venue**: IEEE International Conference on Robotics and Automation (ICRA) 2022.

**Award**: Outstanding Deployed Systems Paper Award.
...
#### [Paper Link](https://doi.org/10.1109/ICRA46639.2022.9812401) {.centered-text}
